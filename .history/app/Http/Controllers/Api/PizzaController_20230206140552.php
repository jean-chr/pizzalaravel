...
class PizzaController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return response()->json(['status' => false, 'messages' => 'recuperation  pizza echouees ,pas authorisé'], 401);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'status' => true,
                'messages' => ' liste pizza avec successfully',
                'pizza' => $pizza
            ], 200);
        } catch (\Exception $e) {
            logger('Something went wrong with addpizza');
            return response()->json(['status' => false, 'messages' => 'erreurs lors de la sauvegarge pizza'], 401);
        }
    }
    ...
    public function show($id)
    {
        ...
        try {
            ...
            logger('Something went wrong with getpizzaByUserId');
            return response()->json(['status' => false, 'messages' => 'Something went wrong deleting the saved pizza'], 401);
        }
    }
