...
class PizzaController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return response()->json(['status' => true, 'messages' => 'recuperation  pizza echouees ,pas authorisé'], 401);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json(['status' => true, 'messages' => 'erreurs lors de la sauvegarge pizza'], 401);
        }
    }
