...
class PizzaController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return response()->json([
                'message' => ' les pizzas recuperer ',
                'pizza' => $pizzas
            ], 200);
        } catch (\Exception $e) {
            logger('Something went wrong with getpizzaByUserId');
            return response()->json(['status' => false, 'message' => 'Something went wrong deleting the saved pizza'], 401);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'status' => true,
                'message' => ' pizza  ajouter avec successfully',
                'pizza' => $pizza
            ], 200);
        } catch (\Exception $e) {
            logger('Something went wrong with addpizza');
            return response()->json(['status' => false, 'message' => 'Something went wrong saving the pizza'], 401);
        }
    }
    ...
    public function show($id)
    {
        ...
        try {
            ...
            return response()->json([
                'message' => 'The pizza was added successfully',
                'pizza' => $pizza
            ], 200);
        } catch (\Exception $e) {
            logger('Something went wrong with getpizzaByUserId');
